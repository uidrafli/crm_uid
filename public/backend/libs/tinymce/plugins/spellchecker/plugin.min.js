  ...
  var c = function (e) {
    ...
    a = function (e) {
      return !(
        ...
        ("undefined" != typeof g.window.console &&
          g.window.console.log &&
          g.window.console.log(
    ...
    p = tinymce.util.Tools.resolve("tinymce.util.URI"),
    v = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    u = function (e) {
  ...
  var k,
    r = function (c, r) {
      ...
      return (
        ...
        (g = r.schema.getWhiteSpaceElements()),
        (h = r.schema.getShortEndedElements()),
        {
          text: (o = (function e(t) {
            var n;
            if (3 === t.nodeType) return t.data;
            if (g[t.nodeName] && !f[t.nodeName]) return "";
            if (x(t)) return "\n";
            if (
              ((n = ""),
              (f[t.nodeName] || h[t.nodeName]) && (n += "\n"),
              (t = t.firstChild))
            )
            ...
            return (
              i.length &&
                (function (e, t, n) {
                  ...
                  e: for (;;) {
                    if (
                      ((f[u.nodeName] || h[u.nodeName] || x(u)) && s++,
                      3 === u.nodeType &&
                        (!o && u.length + s >= a.end
                          ? ((o = u), (c = a.end - s))
                          : r && l.push(u),
                  ...
                  (function (o) {
                    ...
                    return function (e) {
                      ...
                      for (
                        var u = p(o.data.substring(e.startNodeIndex), c),
                          d = 0,
                      ...
                      var m = p(i.data.substring(0, e.endNodeIndex), c);
                      return (
                        (r = o.parentNode).insertBefore(t, o),
                        r.insertBefore(u, o),
                        r.removeChild(o),
                        (r = i.parentNode).insertBefore(m, i),
                        r.insertBefore(n, i),
                        r.removeChild(i),
                        m
                      );
    ...
    S = function (e, t, n) {
      e.dom.select("span.mce-spellchecker-word").length || w(e, t, n);
    },
    w = function (e, t, n) {
      var r = e.selection.getBookmark();
      if (
        (N(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get())
      )
      ...
      addToDictionary: function (t, e, n, r, o, i, c) {
        t.setProgressState(!0),
          y(
            ...
            i,
            function () {
              t.setProgressState(!1), t.dom.remove(c, !0), S(t, n, r);
            },
            function (e) {
              t.notificationManager.open({ text: e, type: "error" }),
                t.setProgressState(!1);
    ...
    R = function (o, i, c, a, l, s) {
      o.on("click", function (e) {
        var t = e.target;
        if ("mce-spellchecker-word" === t.className) {
          e.preventDefault();
          var n = B.findSpansByIndex(o, B.getElmIndex(t));
          if (0 < n.length) {
                ...
                m.each(s, function (e) {
                  ...
                  n.get().hasDictionarySupport &&
                    l.push({
                      ...
                      onclick: function () {
                        B.addToDictionary(t, e, r, o, i, c, a);
                      },
                    }),
                  l.push.apply(l, [
                    {
                      text: "Ignore",
                      onclick: function () {
                        B.ignoreWord(t, r, o, c, a);
                      },
                    },
                    {
                      text: "Ignore all",
                      onclick: function () {
                        B.ignoreWord(t, r, o, c, a, !0);
                      },
                    },
                  ]),
                  (k = D.create("menu", {
                  ...
                  })).renderTo(g.document.body);
                var u = C.DOM.getPos(t.getContentAreaContainer()),
                  d = t.dom.getPos(a[0]),
                  f = t.dom.getRoot();
                "BODY" === f.nodeName
                  ? ((d.x -=
                  ...
                  (u.x += d.x),
                  (u.y += d.y),
                  k.moveTo(u.x, u.y + a[0].offsetHeight);
