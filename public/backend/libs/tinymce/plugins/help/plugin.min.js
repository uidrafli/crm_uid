!(function () {
  ...
  var n,
    ...
    w = C.mac ? "\u2318" : "Ctrl",
    S = C.mac ? "Ctrl + Alt" : "Shift + Alt",
    O = {
      shortcuts: [
        { shortcut: w + " + B", action: "Bold" },
        { shortcut: w + " + I", action: "Italic" },
        { shortcut: w + " + U", action: "Underline" },
        { shortcut: w + " + A", action: "Select all" },
        { shortcut: w + " + Y or " + w + " + Shift + Z", action: "Redo" },
        { shortcut: w + " + Z", action: "Undo" },
        ...
        { shortcut: "Ctrl + F9", action: "Focus to contextual toolbar" },
        {
          shortcut: w + " + K",
          action: "Insert link (if link plugin activated)",
        },
        { shortcut: w + " + S", action: "Save (if save plugin activated)" },
        {
          shortcut: w + " + F",
        ...
        o =
          ...
          e.settings.forced_plugins === undefined
            ...
            : (function (e, t) {
                ...
                r,
                ((n = l(v, e.settings.forced_plugins)),
                function () {
    ...
    j = function () {
      var e,
        ...
        n =
          ...
          "</a>";
      return [
        { type: "label", html: A.translate(["You are using {0}", n]) },
        { type: "spacer", flex: 1 },
        {
          text: "Close",
          onclick: function () {
