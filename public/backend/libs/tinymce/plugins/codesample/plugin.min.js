    ...
    g =
      void 0 !== t
        ...
        : "undefined" != typeof WorkerGlobalScope &&
          u.self instanceof WorkerGlobalScope
        ? u.self
        : {},
    c = (function () {
      var c = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
        S = (g.Prism = {
          ...
          highlightAll: function (e, t) {
            for (
              var a = u.document.querySelectorAll(
            ...
            g.addEventListener(
              ...
              function (e) {
                var t = JSON.parse(e.data),
                  ...
                  n = t.code,
                  i = t.immediateClose;
                g.postMessage(S.highlight(n, S.languages[a], a)),
                  i && g.close();
              },
              !1
            ),
      ...
      (c.hooks.add("before-highlight", function (t) {
        "php" === t.language &&
          ...
          (t.code = t.code.replace(
            ...
            function (e) {
              return (
                t.tokenStack.push(e), "{{{PHP" + t.tokenStack.length + "}}}"
              );
            }
          )));
      }),
  ...
  var d = {
    ...
    k = function (t) {
      t.addCommand("codesample", function () {
        ...
        t.selection.isCollapsed() || d.isCodeSample(e)
          ? v(t)
