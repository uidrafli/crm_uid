!(function (u) {
  ...
  var e,
    ...
    pe = {
      ...
      getSelectedListRoots: function (e) {
        var n,
          ...
          r,
          o =
            ((t = me((n = e), n.selection.getStart())),
            (r = J(n.selection.getSelectedBlocks(), N)),
            t.toArray().concat(r));
        return ge(e, o);
      },
    },
    ...
    he = {
      fromHtml: function (e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (
            (u.console.error("HTML does not have a single root node", e),
    ...
    nn = function (e) {
      var n = e.dom();
      return Y(n.childNodes, he.fromDom);
    },
    tn = function (e, n) {
    ...
    bn = function (e) {
      var n = nn(e),
        t = on(e).map(Nn).getOr(!1) ? n.slice(0, -1) : n;
      return Y(t, gn);
    },
    ...
    _n = function (e) {
      var n,
        t,
        r = Y(pe.getSelectedListItems(e), he.fromDom);
      return ye(
        [
          ee(r, B(Sn)),
          ee(((n = r), (t = Q.call(n, 0)), t.reverse(), t), B(Sn)),
        ],
        function (e, n) {
      ...
      G(o, function (e) {
        ...
        (n = e.entries),
          ...
          (o = te(
            ...
            function (e) {
              return re(e).map(Cn).getOr(!1) ? In(i, e) : Rn(i, e);
            }
          )),
          G(o, function (e) {
            un(r, e);
    ...
    jn = function (e, n) {
      var t = Y(pe.getSelectedListRoots(e), he.fromDom),
        r = Y(pe.getSelectedDlItems(e), he.fromDom),
        o = !1;
