!(function (_) {
      ...
      for (r in (d || (d = l._delegates = {}), i)) {
        ...
        "wheel" !== r || tt
          ? ("mouseenter" === r || "mouseleave" === r
              ? l._hasMouseEnter ||
                (we(l.getEl()).on("mouseleave", s).on("mouseover", u),
                (l._hasMouseEnter = 1))
  ...
  function ft(e, h) {
    ...
    (t = function (e) {
      ...
      (p = function (e) {
        dt(e),
          we(x).off("mousemove touchmove", v).off("mouseup touchend", p),
          m.remove(),
          h.stop && h.stop(e);
      }),
    ...
    Kt = Gt.extend({
      ...
      postRender: function () {
        ...
        n._super(),
          ...
          we(n.getEl("button")).on("click touchstart", function (e) {
    ...
    vn = {
      fromHtml: function (e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (
            (_.console.error("HTML does not have a single root node", e),
        ...
        return (
          e.settings.multiline &&
            ...
            (t.startMinH =
              t.h =
              t.minH =
                Math.min(t.maxH, Re.getSize(e.getEl()).height))),
          t
        );
      },
      repaint: function () {
    ...
    xr = Wt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          ((e = Re.create(i.multiline ? "textarea" : "input", t)).value =
            n.state.get("value")),
