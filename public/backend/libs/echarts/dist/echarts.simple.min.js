!(function (t, e) {
  ...
  function Xe(t, e, n, i) {
    return (
      ...
      i || !Yl.canvasSupported
        ? Ue(t, e, n)
        : Yl.browser.firefox && null != e.layerX && e.layerX !== e.offsetX
    ...
    for (var a = 0, o = 0, s = 0, l = 0, h = 0, u = 0; u < t.length; ) {
      ...
      switch (
        ...
        case Sc.C:
          if (n) {
            if (
              Un(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], e, i, r)
            )
              return !0;
          } else
            a +=
  ...
  function Va(t, e, n, i, r) {
    function a(n) {
      var a = n.uid,
        s = o.get(a) || o.set(a, wa({ plan: Ua, reset: Ya, count: ja }));
      (s.context = {
        model: n,
        ecModel: i,
        api: r,
    ...
    return (
      (l =
        0 === t.indexOf("image://")
          ...
          : 0 === t.indexOf("path://")
          ? mi(t.slice(7), {}, new Nt(e, n, i, r), o ? "center" : "cover")
          : new Np({
    ...
    clear: function (t, e) {
      ...
      if (
        ...
        e.colorStops
          ? ((h =
              e.__canvasGradient ||
              Zh.getGradient(i, e, { x: 0, y: 0, width: r, height: a })),
  ...
  var Xc = ai.extend({
              ...
              for (var r = 0; r < n.length; r++) {
                ...
                if (
                  ...
                  for (l = 0; l < Uc.length; l++)
                    (Uc[l][2] = i[Uc[l][0]]), (i[Uc[l][0]] = Uc[l][1]);
                  e = !0;
                  break;
                }
              }
            if ((t.apply(this, arguments), e))
              for (var l = 0; l < Uc.length; l++) i[Uc[l][0]] = Uc[l][2];
          }
        : t;
    },
    Zc = ai.extend({
    ...
    Kc = function (t, e, n, i) {
      ...
      if (i) {
        (o = [1 / 0, 1 / 0]), (s = [-1 / 0, -1 / 0]);
        for (var f = 0, d = t.length; f < d; f++) Z(o, o, t[f]), j(s, s, t[f]);
        Z(o, o, i[0]), j(s, s, i[1]);
      }
  ...
  (Cp.type = "list"),
    ...
    (Cp.map = function (t, e, n, i) {
      ...
      (r._indices = this._indices), (r.getRawIndex = r._indices ? Yo : Uo);
      for (
        var a = r._storage,
          o = [],
          s = this._chunkSize,
  ...
  Pa.extend({
    ...
    _createClipPath: function (t, e, n, i, r, a, o) {
      ...
      return (
        Ui(s, { shape: { endAngle: i + (r ? 1 : -1) * Math.PI * 2 } }, o, a), s
      );
    },
