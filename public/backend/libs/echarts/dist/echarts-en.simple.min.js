!(function (t, e) {
      ...
      if ("#" !== i.charAt(0)) {
        ...
        if (-1 !== r && a + 1 === i.length) {
          ...
          switch (o) {
            ...
            case "rgb":
              return 3 !== s.length
                ? void mt(e, 0, 0, 0, 1)
                : (mt(e, dt(s[0]), dt(s[1]), dt(s[2]), l), yt(t, e), e);
            case "hsla":
              return 4 !== s.length
                ? void mt(e, 0, 0, 0, 1)
        ...
        if (7 === i.length) {
          ...
          return h >= 0 && h <= 16777215
            ? (mt(e, (16711680 & h) >> 16, (65280 & h) >> 8, 255 & h, 1),
              yt(t, e),
              e)
            : void mt(e, 0, 0, 0, 1);
        }
      ...
      if ("string" == typeof t) {
        ...
        return (
          a
            ...
            : (!e && (e = new Image()),
              (e.onload = Qt),
              eu.put(t, (e.__cachedImgObj = { image: e, pending: [o] })),
  ...
  function pe(t, e) {
    ...
    for (var i, r = (au.lastIndex = 0); null != (i = au.exec(t)); ) {
      var a = i.index;
      a > r && ge(n, t.substring(r, a)), ge(n, i[2], i[1]), (r = au.lastIndex);
    }
  ...
  function Se(t, e, n, i, r) {
    ...
    for (var _ = 0; _ < n.lines.length; _++) {
      for (
        ...
        Ie(t, e, x, i, M, v, C, "left"), (I -= x.width), (C += x.width), T++;
      for (; k >= 0 && "right" === (x = b[k]).textAlign; )
        Ie(t, e, x, i, M, v, D, "right"), (I -= x.width), (D -= x.width), k--;
  ...
  function Ce(t, e, n, i, r, a, o) {
    ...
    if (
      ...
      c ? ve(e, { x: i, y: r, width: a, height: o, r: c }) : e.rect(i, r, a, o),
        e.closePath();
    }
  ...
  function Xe(t, e, n, i) {
    return (
      ...
      i || !Ul.canvasSupported
        ? Ze(t, e, n)
        : Ul.browser.firefox && null != e.layerX && e.layerX !== e.offsetX
  ...
  function cn(t) {
    ...
    ku(t, function (t, n) {
      ...
      ku(t, function (t, n) {
        ...
        if (Au(r)) {
          if (
            ((a.name = null != r.name ? r.name + "" : i ? i.name : Pu + n), i)
          )
            a.id = i.id;
  ...
  function xn(t) {
    var e = { main: "", sub: "" };
    return (
      t && ((t = t.split(Bu)), (e.main = t[0] || ""), (e.sub = t[1] || "")), e
    );
  }
  function wn(t) {
    L(
  ...
  function En(t, e, n, i, r, a, o, s, l, h, u) {
    ...
    return u && ((u[0] = kn(t, n, r, o, c)), (u[1] = kn(e, i, a, s, c))), qu(v);
  }
  function Bn(t, e, n, i) {
    var r = 1 - i;
  ...
  function Wn(t, e, n, i, r, a) {
    (r[0] = Qu(t, n)), (r[1] = Qu(e, i)), (a[0] = Ju(t, n)), (a[1] = Ju(e, i));
  }
  ...
  function jn(t, e, n, i, r, a, o, s, l) {
    ...
    return (
      f < 0 && (f += bc), (f >= i && f <= r) || (f + bc >= i && f + bc <= r)
    );
  }
    ...
    for (var a = 0, o = 0, s = 0, l = 0, h = 0, u = 0; u < t.length; ) {
      ...
      switch (
        ...
        case Sc.C:
          if (n) {
            if (
              Zn(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], e, i, r)
            )
              return !0;
          } else
            a +=
              Jn(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], i, r) ||
              0;
          (o = t[u++]), (s = t[u++]);
          break;
        case Sc.Q:
          if (n) {
            if (Un(o, s, t[u++], t[u++], t[u], t[u + 1], e, i, r)) return !0;
  ...
  function Ii(t) {
    if (!t.__isHover) {
      if ((Mi(t), t.useHoverLayer)) t.__zr && t.__zr.addHover(t, t.__hoverStl);
      else {
        var e = t.style,
  ...
  function Fi(t, e, n, i, r, a) {
    ...
    (t.fontStyle = e.getShallow("fontStyle") || n.fontStyle),
      ...
      (a && i.disableBox) ||
        ((t.textBackgroundColor = Vi(e.getShallow("backgroundColor"), i)),
  ...
  function _r(t, e, n) {
    ...
    switch (
      ...
      isNaN(u) && (u = r - l - c - o),
      null != d &&
        (isNaN(h) && isNaN(u) && (d > i / r ? (h = 0.8 * i) : (u = 0.8 * r)),
        isNaN(h) && (h = d * u),
        isNaN(u) && (u = h / d)),
      isNaN(a) && (a = i - s - h - f),
      isNaN(o) && (o = r - l - u - c),
  ...
  function xr(t, e, n) {
    function i(n, i) {
      ...
      if (
        ...
        return (
          a(e, n[1]) ? (h[n[2]] = null) : a(e, n[2]) && (h[n[1]] = null), h
        );
      if (2 !== u && l) {
        if (l >= 2) return o;
  ...
  function Lr(t, e, n, i, r) {
    ...
    if (e === Wf)
      "auto" === i || null == i
        ...
        (a = r ? r.length : n === Uf ? t.length : t[0] ? t[0].length : null);
  ...
  function Or(t, e, n, i) {
    ...
    else for (var r = n[0] || [], a = 0; a < r.length && a < i; a++) t(r[a], a);
  }
  function Er(t) {
  ...
  function ea(t, e, n) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var i = t[e].normal,
        r = t[e].emphasis;
      i &&
        (n ? ((t[e].normal = t[e].emphasis = null), o(t[e], i)) : (t[e] = i)),
      ...
      var i = [],
        ...
        l = o.map(a, function (a, l, h) {
          ...
          for (var d = NaN, p = n - 1; p >= 0; p--) {
            var g = t[p];
            if (
              (s || (f = g.data.rawIndexOf(g.stackedByDimension, c)), f >= 0)
            ) {
  ...
  function Va(t, e, n, i, r) {
    function a(n) {
      var a = n.uid,
        s = o.get(a) || o.set(a, wa({ plan: Za, reset: Ua, count: ja }));
      (s.context = {
        model: n,
        ecModel: i,
        api: r,
  ...
  function uo(t, e, n, i) {
    function r(t) {
      ...
      if (!r) {
        var u = qd(t.type);
        (r = new (a ? xd.getClass(u.main, u.sub) : Pa.getClass(u.sub))()).init(
          n,
          h
        ),
          (s[e] = r),
  ...
  function Yo(t, e) {
    var n = t._idList[e];
    return (
      null == n && (n = t._getIdFromStore(e)), null == n && (n = wp + e), n
    );
  }
  function jo(t) {
    return y(t) || (t = [t]), t;
  ...
  function $o(t, e) {
    ...
    qo(i, t);
    for (
      var r = (i._storage = {}), o = t._storage, s = a({}, t._rawExtent), h = 0;
      h < n.length;
      h++
    ) {
      var u = n[h];
      o[u] &&
        (l(e, u) >= 0 ? ((r[u] = Ko(o[u])), (s[u] = Qo())) : (r[u] = o[u]));
    }
    return i;
  }
  function Ko(t) {
    ...
    return (
      (l =
        0 === t.indexOf("image://")
          ...
          : 0 === t.indexOf("path://")
          ? mi(t.slice(7), {}, new Rt(e, n, i, r), o ? "center" : "cover")
          : new Rp({
  ...
  function Ls(t, e, n) {
    ...
    for (var i = [], r = 0, a = e.count(); r < a; r++) i.push(xs(n, t, e, r));
    return i;
  }
  function Ps(t, e, n) {
      ...
      if (e) {
        ...
        (this._dropTarget = o),
          e !== o &&
            (s &&
              o !== s &&
              this.dispatchToElement(K(s, t), "dragleave", t.event),
            o &&
              o !== s &&
              this.dispatchToElement(K(o, t), "dragenter", t.event));
      }
    },
    _dragEnd: function (t) {
      var e = this._draggingTarget;
      e && (e.dragging = !1),
        ...
        this._dropTarget &&
          this.dispatchToElement(K(this._dropTarget, t), "drop", t.event),
  ...
  ch.prototype = {
    ...
    triggerWithContext: function (t) {
      if (this._$handlers[t]) {
        ...
        for (
          var i = e[e.length - 1], r = this._$handlers[t], a = r.length, o = 0;
          o < a;
  ...
  (Wh.prototype = {
    ...
    _doAdd: function (t) {
      ...
      e &&
        e !== t.__storage &&
        (e.addToStorage(t), t instanceof Wh && t.addChildrenToStorage(e)),
        n && n.refresh();
    },
    remove: function (t) {
      var e = this.__zr,
    ...
    delChildrenFromStorage: function (t) {
      for (var e = 0; e < this._children.length; e++) {
        var n = this._children[e];
        t.delFromStorage(n), n instanceof Wh && n.delChildrenFromStorage(t);
      }
    },
    dirty: function () {
  ...
  Yh.prototype = {
    ...
    blend: null,
    bind: function (t, e, n) {
      for (var i = this, r = n && n.style, a = !r, o = 0; o < Uh.length; o++) {
        var s = Uh[o],
          l = s[0];
    ...
    clear: function (t, e) {
      ...
      if (
        ...
        e.colorStops
          ? ((h =
              e.__canvasGradient ||
              Yh.getGradient(i, e, { x: 0, y: 0, width: r, height: a })),
    ...
    _updateLayerStatus: function (t) {
      ...
      for (var n = null, i = 0, r = 0; r < t.length; r++) {
        ...
        o.incremental
          ...
          a.__builtin__ ||
            Bh("ZLevel " + s + " has been used by unkown layer " + a.id),
          a !== n &&
            ((a.__used = !0),
  ...
  var Tu = !Ul.canvasSupported,
    ...
    Du = function (t, e, n) {
      ...
      (this.handler = new ph(r, o, s, o.root)),
        (this.animation = new vu({ stage: { update: m(this.flush, this) } })),
  ...
  (xc.prototype = {
    ...
    _dashedLineTo: function (t, e) {
      var n,
        ...
        g = o.length;
      for (
        u /= f, c /= f, a < 0 && (a = r + a), d -= (a %= r) * u, p -= a * c;
        (u > 0 && d <= t) ||
        (u < 0 && d >= t) ||
        (0 == u && ((c > 0 && p <= e) || (c < 0 && p >= e)));
    ...
    toStatic: function () {
      var t = this.data;
      t instanceof Array &&
        ((t.length = this._len), _c && (this.data = new Float32Array(t)));
    },
    getBoundingRect: function () {
      ...
      for (
        ...
        switch ((1 == a && ((i = e = t[a]), (r = n = t[a + 1])), o)) {
          case lc.M:
            ...
            break;
          case lc.L:
            Wn(e, n, t[a], t[a + 1], cc, fc), (e = t[a++]), (n = t[a++]);
            break;
          case lc.C:
  ...
  (qc.prototype = {
    ...
    brush: function (t, e) {
      ...
      null != i && (i += ""),
        n.bind(t, this, e),
        Be(i, n) &&
          (this.setTransform(t), xe(this, t, i, n), this.restoreTransform(t));
    },
    getBoundingRect: function () {
      var t = this.style;
  ...
  var Xc = ai.extend({
              ...
              for (var r = 0; r < n.length; r++) {
                ...
                if (
                  ...
                  for (l = 0; l < Zc.length; l++)
                    (Zc[l][2] = i[Zc[l][0]]), (i[Zc[l][0]] = Zc[l][1]);
                  e = !0;
                  break;
                }
              }
            if ((t.apply(this, arguments), e))
              for (var l = 0; l < Zc.length; l++) i[Zc[l][0]] = Zc[l][2];
          }
        : t;
    },
    Yc = ai.extend({
    ...
    Kc = function (t, e, n, i) {
      ...
      if (i) {
        (o = [1 / 0, 1 / 0]), (s = [-1 / 0, -1 / 0]);
        for (var f = 0, d = t.length; f < d; f++) Y(o, o, t[f]), j(s, s, t[f]);
        Y(o, o, i[0]), j(s, s, i[1]);
      }
    ...
    gf = (Object.freeze || Object)({
      ...
      clipPointsByRect: function (t, e) {
        return d(t, function (t) {
          ...
          var i = t[1];
          return (i = ff(i, e.y)), (i = df(i, e.y + e.height)), [n, i];
        });
      },
        ...
        if (t.length) {
          ...
          for (
            ...
            var u = l.pop(),
              c = s[u],
              d = !!h[u];
            d && (i.call(r, u, c.originalDeps.slice()), delete h[u]),
              f(
                c.successor,
                d
                  ? function (t) {
    ...
    Ff = {
      ...
      singleAxis: function (t, e, n, i) {
        ...
        (e.coordSysDims = ["single"]),
          n.set("single", r),
          Ir(r) && (i.set("single", r), (e.firstCategoryDimIndex = 0));
      },
      polar: function (t, e, n, i) {
        ...
        (e.coordSysDims = ["radius", "angle"]),
          n.set("radius", a),
          n.set("angle", o),
          Ir(a) && (i.set("radius", a), (e.firstCategoryDimIndex = 0)),
  ...
  (Tr.seriesDataToSource = function (t) {
    return new Tr({ data: t, sourceFormat: S(t) ? Xf : Vf, fromDataset: !1 });
  }),
    Sn(Tr);
  var Yf = gn(),
    jf = "\0_ec_inner",
  ...
  (vd.perform = function (t) {
    ...
    var a;
    (this._dirty || "reset" === r) && ((this._dirty = !1), (a = Sa(this, n)));
    var o = t && t.step;
    if (
      ((this._dueEnd = e
        ? e._outputDueEnd
      ...
      !n && (a || s < l) && this._progress({ start: s, end: l }, this.context),
        (this._dueIndex = l);
      ...
      if (a.get("show"))
        if (a.get("description"))
          ...
          if (!(o < 1)) {
            ...
            var d = [];
            (s += n(
              i(o > 1 ? "series.multiple.prefix" : "series.single.prefix"),
              { seriesCount: o }
            )),
              e.eachSeries(function (t, e) {
                if (e < u) {
                  ...
                  (window.data = c),
                    c.count() > l
                      ? (a += n(i("data.partialData"), { displayCnt: l }))
                      : (a += i("data.allData"));
  ...
  (Ld.getPerformArgs = function (t, e) {
    ...
    (Ld.updateStreamModes = function (t, e) {
      ...
      t.pipelineContext = n.context = { canProgressiveRender: r, large: a };
    }),
  ...
  (Jd._onframe = function () {
    ...
    (Jd.setOption = function (t, e, n) {
      var i;
      if (
        (Gd(e) && ((n = e.lazyUpdate), (i = e.silent), (e = e.notMerge)),
        (this[$d] = !0),
        !this._model || e)
      ) {
  ...
  ko(2e3, Cd),
    ...
    Lo("default", function (t, e) {
      ...
      var n = new tf({
        ...
        i = new af({
          shape: { startAngle: -Ad / 2, endAngle: -Ad / 2 + 0.1, r: 10 },
  ...
  (Cp.type = "list"),
    ...
    (Cp._initDataFromProvider = function (t, e) {
      if (!(t >= e)) {
        for (
          ...
          for (M = f * i; M < e; M += i) a[I].push(new m(Math.min(e - M, i)));
          this._chunkCount = a[I].length;
        }
        for (var x = t; x < e; x++) {
          for (
            var w = r.getItem(x), b = Math.floor(x / i), S = x % i, M = 0;
            M < o.length;
            M++
          ) {
            var I = o[M],
    ...
    (Cp.indicesOfNearest = function (t, e, n) {
      ...
      for (
        ...
        l <= n &&
          h <= r &&
          ((h < r || (l >= 0 && a < 0)) && ((r = h), (a = l), (i.length = 0)),
          i.push(o));
      }
      return i;
    }),
    ...
    (Cp.each = function (t, e, n, i) {
      if (this._count) {
        "function" == typeof t && ((i = n), (n = e), (e = t), (t = [])),
          (n = n || i || this);
        for (
          var r = (t = d(jo(t), this.getDimension, this)).length, a = 0;
          a < this.count();
          a++
        )
          switch (r) {
    ...
    (Cp.map = function (t, e, n, i) {
      ...
      (r._indices = this._indices), (r.getRawIndex = r._indices ? Uo : Zo);
      for (
        var a = r._storage,
          o = [],
          s = this._chunkSize,
  ...
  (Np._updateCommon = function (t, e, n, i) {
    ...
    if (p && o.isAnimationEnabled()) {
      var w = function () {
        ...
        b = function () {
          this.incremental || this.animateTo({ scale: x }, 400, "elasticOut");
        };
  ...
  (Hp.updateData = function (t, e) {
    ...
    r || n.removeAll(),
      t
        ...
        .update(function (s, l) {
          ...
          gs(t, u, s, e)
            ? (h
                ? (h.updateData(t, s, o), Xi(h, { position: u }, i))
    ...
    (Hp.incrementalPrepareUpdate = function (t) {
      (this._seriesScope = vs(t)), (this._data = null), this.group.removeAll();
    }),
  ...
  Pa.extend({
    ...
    render: function (t, e, n) {
      var i = t.coordinateSystem,
        ...
        x = t.get("showSymbol"),
        w =
          x && !u && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(a, i),
        b = this._data;
      b &&
          ...
          (Ds(this._stackedOnPoints, _) && Ds(this._points, h)) ||
            (m
              ...
              : (S && ((h = Bs(h, i, S)), (_ = Bs(_, i, S))),
                d.setShape({ points: h }),
                p && p.setShape({ points: h, stackedOnPoints: _ })));
      } else
      ...
      d.useStyle(
        o(s.getLineStyle(), { fill: "none", stroke: I, lineJoin: "bevel" })
      );
      var T = t.get("smooth");
      if (
        ((T = ks(t.get("smooth"))),
        ...
        var C = a.getCalculationInfo("stackedOnSeries"),
          D = 0;
        p.useStyle(
          o(l.getAreaStyle(), { fill: I, opacity: 0.7, lineJoin: "bevel" })
        ),
          C && (D = ks(C.get("smooth"))),
          p.setShape({
            smooth: T,
    ...
    _newPolygon: function (t, e) {
      ...
      return (
        ...
        (n = new Qp({ shape: { points: t, stackedOnPoints: e }, silent: !0 })),
  ...
  var pg = Ns.prototype,
    ...
    bg = Ns.extend({
      ...
      setExtent: function (t, e) {
        var n = this.base;
        (t = wg(t) / wg(n)), (e = wg(e) / wg(n)), gg.setExtent.call(this, t, e);
      },
      getExtent: function () {
        var t = this.base,
  ...
  var Ag = ["value", "category", "time", "log"],
    ...
    Og = Ef.extend({
      ...
      mergeOption: function () {
        Og.superApply(this, "mergeOption", arguments), this.resetRange();
      },
      restoreData: function () {
        Og.superApply(this, "restoreData", arguments), this.resetRange();
      },
  ...
  var Vg = Math.PI,
    Wg = function (t, e) {
      (this.opt = e),
        ...
        (this.group = new Wh());
      var n = new Wh({ position: e.position.slice(), rotation: e.rotation });
      n.updateTransform(),
            ...
            f(
              ...
              function (e, n) {
                if ("none" !== l[n] && null != l[n]) {
                  ...
                  i.attr({ rotation: e.rotate, position: o, silent: !0 }),
                    this.group.add(i);
                }
              },
              this
      ...
      axisName: function () {
        ...
        if (n) {
          ...
          var p = s.getFont(),
            ...
            y =
              null != m && null != v
                ? Df(n, v, p, m, { minChar: 2, placeholder: g.placeholder })
                : n,
            _ = e.get("tooltip", !0),
            x = e.mainType,
      ...
      _splitArea: function (t, e, n) {
        ...
        if (!i.scale.isBlank()) {
          ...
          for (
            ...
            if (!(Yg(i, _, p, h.length, m, v) && _ < h.length - 1)) {
              var x,
                w,
                b,
                S,
              ...
              i.isHorizontal()
                ? ((x = c), (w = l.y), (b = M - x), (S = l.height))
                : ((x = l.x), (w = f), (b = l.width), (S = M - w));
              var I = d++ % s.length;
              this._axisGroup.add(
                new tf({
                  anid: "area_" + u[_],
        ...
        return {
          ...
          reset: function (t, i, r) {
            var a = t.getData(),
              ...
              s = t.get("symbolSize");
            if (
              (a.setVisual({ legendSymbol: n || o, symbol: o, symbolSize: s }),
                ...
                a && {
                  progress: function (t, e) {
                    for (
                      ...
                      i
                        ? ((s[h++] = f ? f[0] : NaN), (s[h++] = f ? f[1] : NaN))
                        : e.setItemLayout(l, (f && f.slice()) || [NaN, NaN]);
                    }
      ...
      _render: function (t, e, n) {
        ...
        a
          ...
          .remove(function (t) {
            ...
            "cartesian2d" === s.type ? e && Bl(t, h, e) : e && Rl(t, h, e);
          })
          .execute(),
          (this._data = a);
      },
  ...
  var nm = {
      cartesian2d: function (t, e, n, i, r, o, s) {
        ...
        if (o) {
          ...
          (h[u] = 0),
            (c[u] = i[u]),
            gf[s ? "updateProps" : "initProps"](l, { shape: c }, o, e);
        }
        return l;
      },
      polar: function (t, e, n, i, r, a, s) {
        ...
        if (a) {
          ...
          (u[c] = r ? 0 : i.startAngle),
            (f[c] = i[c]),
            gf[s ? "updateProps" : "initProps"](h, { shape: f }, a, e);
        }
        return h;
      },
    },
        ...
        function (t) {
          ...
          for (
            ...
            if (!isNaN(_)) {
              var w = _ >= 0 ? "p" : "n",
                b = m;
              p && (a[o][x] || (a[o][x] = { p: m, n: m }), (b = a[o][x][w]));
              var S, M, I, T;
              if (g)
                (S = b),
  ...
  (sm.updateData = function (t, e, n) {
    ...
    s.useStyle(
      o({ lineJoin: "bevel", fill: f }, h.getModel("itemStyle").getItemStyle())
    ),
  ...
  Pa.extend({
    ...
    render: function (t, e, n, i) {
      if (!i || i.from !== this.uid) {
        ...
        if (
          ...
          o.setClipPath(
            this._createClipPath(f.cx, f.cy, d, f.startAngle, f.clockwise, p, t)
          );
        }
        this._data = r;
      }
    ...
    _createClipPath: function (t, e, n, i, r, a, o) {
      ...
      return (
        Zi(s, { shape: { endAngle: i + (r ? 1 : -1) * Math.PI * 2 } }, o, a), s
      );
    },
  ...
  !(function (t, e) {
    ...
    (t.init = function (t, e, n) {
      ...
      if (i) return i;
      var r = new eo(t, e, n);
      return (r.id = "ec_" + fp++), (up[r.id] = r), yn(t, pp, r.id), wo(r), r;
    }),
