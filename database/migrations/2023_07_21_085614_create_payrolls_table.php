...
class CreatePayrollsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payrolls', function (Blueprint $table) {
            ...
            $table->bigInteger('jumlah_tunjangan_transport');
            $table->bigInteger('uang_tunjangan_transport');
            $table->bigInteger('total_tunjangan_transport');

            $table->bigInteger('jumlah_tunjangan_makan');
            $table->bigInteger('uang_tunjangan_makan');
            $table->bigInteger('total_tunjangan_makan');

            $table->bigInteger('total_tunjangan_bpjs_kesehatan');

            $table->bigInteger('total_tunjangan_bpjs_ketenagakerjaan');

            $table->bigInteger('total_potongan_bpjs_kesehatan');

            $table->bigInteger('total_potongan_bpjs_ketenagakerjaan');
            ...
            $table->bigInteger('bonus_pribadi');
            $table->bigInteger('bonus_team');
            $table->bigInteger('bonus_jackpot');
