                ...
                <form method="post" class="p-4" action="{{ url('/inventory/store') }}">
                    @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_barang') is-invalid @enderror" id="kode_barang" name="kode_barang" value="{{ old('kode_barang', $kode_barang) }}">
                            @error('kode_barang')
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <input type="number" step="0.01" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" value="{{ old('stok') }}">
                                @error('stok')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
