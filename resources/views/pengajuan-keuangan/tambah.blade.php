...
@section('container')
    <div id="app-wrap" class="style1">
        <div class="tf-container">
            <form method="post" class="tf-form p-2" action="{{ url('/pengajuan-keuangan/store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="group-input">
                    ...
                    <input type="text" class="@error('nomor') is-invalid @enderror" id="nomor" name="nomor" value="{{ old('nomor', $nomor) }}" readonly>
                </div>

                <div class="group-input">
                    <label for="tanggal">Tanggal</label>
                    <input type="datetime" class="@error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}">
                    @error('tanggal')
                ...
                <div class="group-input">
                    ...
                    <input type="text" class="money @error('total_harga') is-invalid @enderror" id="total_harga" name="total_harga" value="{{ old('total_harga') }}" readonly>
                    @error('total_harga')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="group-input">
                    ...
                    <textarea name="keterangan" id="keterangan" class="@error('keterangan') is-invalid @enderror">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
