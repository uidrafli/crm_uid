...
@section('isi')
    ...
    <div class="container my-1">
        ...
        <form method="POST" action="{{ url('/registration/update-form/' . $data->id_events_form) }}" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input type="date" name="start_date" value="{{ old('start_date', $data->start_date) }}"
                                    class="form-control input-sm" id="start_date">
                            </div>
                            <div class="col-sm">
                                ...
                                <input type="date" name="end_date" value="{{ old('end_date', $data->end_date) }}"
                                    class="form-control input-sm" id="end_date">
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input type="time" name="start_time" value="{{ old('start_time', $data->start_time) }}"
                                    class="form-control input-sm" id="start_time">
                            </div>
                            <div class="col-sm">
                                ...
                                <input type="time" name="end_time" value="{{ old('end_time', $data->end_time) }}"
                                    class="form-control input-sm" id="end_time">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <label for="logo_size_mobile" class="form-label" style="color: #888888; font-weight: 700;">Logo Size Mobile <span class="text-danger"><i>max 350px</i></span>
                                    <span class="text-danger">*</span></label>
                                <input type="number" name="logo_size_mobile" value="{{ old('logo_size_mobile', $data->logo_size_mobile) }}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        type="checkbox" name="salutation" value="Salutation"
                                        {{ old('salutation', $data->salutation) ? 'checked' : '' }} id="salutation">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        -webkit-transform: scale(1.3);
                                        -ms-transform: scale(1.3);"
                                        type="checkbox" name="fullname" value="Full Name"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        -webkit-transform: scale(1.3);
                                        -ms-transform: scale(1.3);"
                                        type="checkbox" name="email" value="Email"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        {{ old('institution', $data->institution) ? 'checked' : '' }} id="institution">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        -webkit-transform: scale(1.3);
                                        -ms-transform: scale(1.3);"
                                        type="checkbox" name="sector" value="Sector" {{ old('sector', $data->sector) ? 'checked' : '' }} id="sector">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        -webkit-transform: scale(1.3);
                                        -ms-transform: scale(1.3);"
                                        type="checkbox" name="field" value="Field" {{ old('field', $data->field) ? 'checked' : '' }} id="field">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <input class="form-check-input topic-checkbox"
                                        ...
                                        -webkit-transform: scale(1.3);
                                        -ms-transform: scale(1.3);"
                                        type="checkbox" name="country" value="Country" {{ old('country', $data->country) ? 'checked' : '' }} id="country">
