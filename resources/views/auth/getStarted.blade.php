    ...
    <body>
        ...
        <div class="boarding-section">
            <div class="tf-container">
                <img src="{{ url('/storage/'.$settings->logo) }}" style="width: 200px" alt="image">
            </div>
        </div>
        ...
        <div class="boarding-content mt-7">
            <div class="tf-container">
                <div class="boarding-title">
                    <h1 class="tf-title">{{ $settings->name }}</h1>
                    <p>Start managing your employee for a better and more organized future for your life</p>
                </div>
