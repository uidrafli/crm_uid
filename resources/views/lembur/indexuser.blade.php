        ...
        @if (!$lembur)
            <form method="post" action="{{ url('/lembur/masuk') }}">
                ...
                <div class="tf-container">
                    ...
                    <button type="submit" class="tf-btn accent large" onClick="take_snapshot()">Masuk Overtime</button>
                </div>
            </form>
            <br>
            <br>
        ...
        @elseif($lembur && $lembur->jam_keluar == null)
            <form method="post" action="{{ url('/lembur/pulang/'.$lembur->id) }}">
                ...
                <div class="tf-container">
                    ...
                    <button type="submit" class="tf-btn accent large" onClick="take_snapshot()">Pulang Overtime</button>
                </div>
            </form>
            <br>
            <br>
        ...
        @else
            <center>
                ...
                <img src="{{ asset('assets/icon-image/rest.png') }}" alt="Rest"
                    style="width: 50%; height: auto; margin-top: 15px;">
            </center>
        @endif
    </div>
