                        ...
                        <table id="mytable" class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($data_absen as $key => $da)
                                    ...
                                    @else
                                        <tr>
                                            <td>{{ ($data_absen->currentpage() - 1) * $data_absen->perpage() + $key + 1 }}.
                                            </td>
                                            <td>{{ $da->name }}</td>
                                            <td>
                                                @if ($da->Shift)
                                            ...
                                            <td>
                                                ...
                                                @elseif($da->status_absen == 'Replace Off')
                                                    <span class="badge badge-warning">Replace Off</span>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{ url('/maps/' . $da->lat_pulang . '/' . $da->long_pulang . '/' . $da->User->id) }}"
                                                        style="background-color: rgb(146, 146, 146)" class="btn btn-xs"
                                                        target="_blank"><i class="fa fa-eye" class="me-2"></i>
                                                        Lihat</a>
                                            ...
                                            <td>
                                                ...
                                                @elseif(
                                                    $da->status_absen == 'Cuti' ||
                                                        $da->status_absen == 'Izin Telat' ||
                                                        $da->status_absen == 'Izin Pulang Cepat' ||
                                                        $da->status_absen == 'Izin Masuk' ||
                                                        $da->status_absen == 'Sakit')
                                            ...
                                            <td>
                                                <ul class="action">
                                                    ...
                                                    @if ($da->id)
                                                        <li class="delete">
                                                            <form action="{{ url('/data-absen/' . $da->id . '/delete') }}"
