...
@section('isi')
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <form method="post" class="p-4" action="{{ url('/role/store') }}">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('guard_name') is-invalid @enderror" id="guard_name" name="guard_name" value="{{ old('guard_name', 'web') }}" readonly>
                            @error('guard_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
