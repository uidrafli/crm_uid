...
@section('isi')
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="p-4" action="{{ url('/target-kinerja/update/'.$target_kinerja->id) }}">
                        @method("PUT")
                        @csrf
                        <div class="row mb-3">
                            <div class="col">
                                <label for="nomor" class="float-left">Nomor Target Kinerja</label>
                                <input type="text" class="form-control borderi @error('nomor') is-invalid @enderror" id="nomor" name="nomor" value="{{ old('nomor', $target_kinerja->nomor) }}" readonly>
                                @error('nomor')
                            ...
                            <table class="table" id="tablemultiple" style="font-size:12px">
                                ...
                                <tbody>
                                    @if(isset($old['user_id']))
                                        ...
                                        @endforeach
                                    @else
                                        @foreach ($target_kinerja->team  as $key => $item)
                                            <tr id="multiple{{ $key }}">
                                                <td style="vertical-align: middle;">
                                                    <select class="form-control borderi select2 user_id" id="user_id" name="user_id[]">
                                                        <option value="">-- Pilih --</option>
                                                        @foreach ($users as $user)
                                                            <option value="{{ $user->id }}" {{ $user->id == $item->user_id ? 'selected="selected"' : '' }}>
                                                                {{ $user->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" class="form-control borderi jabatan" id="jabatan" name="jabatan[]" value="{{ $item->jabatan->nama_jabatan ?? '' }}" readonly>
                                                </td>

                                                <td style="vertical-align: middle;">
                                                    <input type="text" class="form-control borderi money target_pribadi" id="target_pribadi" name="target_pribadi[]" value="{{ $item->target_pribadi }}">
                                                </td>

                                                <td style="vertical-align: middle;">
                                                    <div class="input-group" style="width: 120px">
                                                        <input type="number" class="form-control borderi jumlah_persen_pribadi" id="jumlah_persen_pribadi" name="jumlah_persen_pribadi[]" value="{{ $item->jumlah_persen_pribadi }}">
                                                        <div class="input-group-text borderi">
                                                            <span>%</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <input type="text" class="form-control borderi money bonus_pribadi" id="bonus_pribadi" name="bonus_pribadi[]" value="{{ $item->bonus_pribadi }}" readonly>
                                                </td>
                                                ...
                                                <td style="display:none;">
                                                    <input type="hidden" class="jabatan_id" id="jabatan_id" name="jabatan_id[]" value="{{ $item->jabatan_id }}" readonly>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control borderi money @error('target_team') is-invalid @enderror" id="target_team" name="target_team" value="{{ old('target_team', $target_kinerja->target_team) }}" readonly>
                                @error('target_team')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-2">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control borderi @error('jumlah_persen_team') is-invalid @enderror" name="jumlah_persen_team" id="jumlah_persen_team" value="{{ old('jumlah_persen_team', $target_kinerja->jumlah_persen_team) }}" onkeyup="getBonusTeam()">
                                    <div class="input-group-text borderi">
                                        <span>%</span>
                                    </div>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control borderi money @error('bonus_team') is-invalid @enderror" id="bonus_team" name="bonus_team" value="{{ old('bonus_team', $target_kinerja->bonus_team) }}" readonly>
                                @error('bonus_team')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-3">
                                ...
                                <input type="datetime" class="form-control borderi @error('tanggal_awal') is-invalid @enderror" id="tanggal_awal" name="tanggal_awal" value="{{ old('tanggal_awal', $target_kinerja->tanggal_awal) }}">
                                @error('tanggal_awal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-3">
                                ...
                                <input type="datetime" class="form-control borderi @error('tanggal_akhir') is-invalid @enderror" id="tanggal_akhir" name="tanggal_akhir" value="{{ old('tanggal_akhir', $target_kinerja->tanggal_akhir) }}">
                                @error('tanggal_akhir')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control borderi money @error('jackpot') is-invalid @enderror" id="jackpot" name="jackpot" value="{{ old('jackpot', $target_kinerja->jackpot) }}">
                                @error('jackpot')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
