        ...
        <div class="col-md-3">
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <h3 class="profile-username text-center mt-3">{{ $karyawan->name }}</h3>
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                        <b>Telepon</b> <br> <p style="color: black">{{ $karyawan->telepon }}</p>
                        </li>
                    </ul>
                </div>
                <!-- /.card-body -->
                        ...
                        <div class="active tab-pane" id="settings">
                            <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mb-4">
                                        <label for="jabatan_id">Division</label>
                                    ...
                                    {{-- <div class="col mb-4">
                                        <label for="user_approval_2" class="float-left">
                                            Approval Leader <span class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_ro') is-invalid @enderror" id="izin_ro" name="izin_ro" value="{{ old('izin_ro', $karyawan->izin_ro) }}" readonly>
                                        @error('izin_ro')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
