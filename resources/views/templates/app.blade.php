...
<head>
    ...
    <link rel="manifest" href="{{ url('/public/manifest.json') }}" data-pwa-version="set_in_manifest_and_pwa_js">
...
<body>
            ...
            <div class="tf-container">
                <div class="tf-topbar d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <a href="{{ url('/notifications') }}" class="icon-notification1 white_color">
    ...
    @elseif(Request::is('my-profile*') ||
            Request::is('laporan-kerja') ||
            Request::is('laporan-kerja/show*') ||
            // Request::is('cuti*') ||
            Request::is('pengajuan-keuangan*') ||
            Request::is('berita-user*') ||
            Request::is('informasi-user*'))
        ...
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('cuti*') ? 'active' : '' }}"><a
                        class="fw_4 d-flex justify-content-center align-items-center flex-column"
                        href="{{ url('/cuti') }}"><svg width="25" height="24" viewBox="0 0 25 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12.25" cy="12" r="9.5"
                                stroke="{{ Request::is('cuti*') ? '#0000FF' : '#717171' }}" />
                            <path
                ...
                <div class="tf-container">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ url('/') }}" class="sidebar-logo">
                            <img src="{{ asset('/storage/' . $settings->logo) }}" style="width: 35px; height: 35px;"
                                alt="logo">
                            <p style="margin-left: 7px; font-size: 16px; color: #ffffff">HRIS R-Tech</p>
                        </a>
                        ...
                        <ul class="box-nav">
                            ...
                            <li>
                                <a href="{{ url('/reimbursement') }}" class="nav-link">
                                    <i class="fa fa-thumbtack"
                                        style="{{ Request::is('reimbursement*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span
                                        style="{{ Request::is('reimbursement*') ? 'color: blue' : '' }}">Reimbursement</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/kunjungan') }}" class="nav-link">
                                    <i class="fa fa-plane-arrival"
                                        style="{{ Request::is('kunjungan*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span
                                        style="{{ Request::is('kunjungan*') ? 'color: blue' : '' }}">Kunjungan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/kinerja-pegawai-user') }}" class="nav-link">
                                    <i class="fa fa-x-ray"
                                        style="{{ Request::is('kinerja-pegawai-user*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span
                                        style="{{ Request::is('kinerja-pegawai-user*') ? 'color: blue' : '' }}">Kinerja
                                        Pegawai</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/penugasan-kerja') }}" class="nav-link">
                                    <i class="fas fa-wave-square"
                                        style="{{ Request::is('penugasan-kerja*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span style="{{ Request::is('penugasan-kerja*') ? 'color: blue' : '' }}">Penugasan
                                        Kerja</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/rapat-kerja') }}" class="nav-link">
                                    <i class="fas fa-vihara"
                                        style="{{ Request::is('rapat-kerja*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span style="{{ Request::is('rapat-kerja*') ? 'color: blue' : '' }}">Rapat
                                        Kerja</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/inventory') }}" class="nav-link">
                                    ...
                                    <span
                                        style="{{ Request::is('inventory*') ? 'color: blue' : '' }}">Inventory</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/exit') }}" class="nav-link">
                                    <i class="fas fa-user-minus"
                                        style="{{ Request::is('exit*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span style="{{ Request::is('exit*') ? 'color: blue' : '' }}">Pegawai
                                        Keluar</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/patroli') }}" class="nav-link">
                                    <i class="fas fa-shield-alt"
                                        style="{{ Request::is('patroli*') ? 'color: blue' : 'color: black' }}"></i>
                            ...
                            <li>
                                <a href="{{ url('/data-patroli') }}" class="nav-link">
                                    <i class="fas fa-oil-can"
                                        style="{{ Request::is('data-patroli*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span style="{{ Request::is('data-patroli*') ? 'color: blue' : '' }}">Data
                                        Patroli</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/euforia') }}" class="nav-link">
                                    <i class="fa fa-baby"
                                        style="{{ Request::is('euforia*') ? 'color: blue' : 'color: black' }}"></i>
    ...
    <script>
        ...
        const channelNameNotif = "messages." + user_id;
        window.Echo.channel(channelNameNotif).listen("NotifApproval", (event) => {
