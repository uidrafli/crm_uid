...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="{{ asset('backend') }}/extra-libs/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet" />
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <div class="header-wrapper row m-0">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                    <div class="logo-wrapper"><a href="{{ url('/dashboard') }}"><img class="img-fluid"
                                src="{{ url('/html/assets/images/logo/login.png') }}" alt=""></a></div>
                        ...
                        <li>
                            <a class="notification-box" href="{{ url('/notifications') }}"><i
                                ...
                                @if (auth()->user()->notifications()->whereNull('read_at')->count() > 0)
                                    <span
                                        class="badge rounded-pill badge-danger">{{ auth()->user()->notifications()->whereNull('read_at')->count() }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="profile-nav onhover-dropdown p-0 me-0">
                            <div class="d-flex profile-media">
                                @if (auth()->user()->foto_karyawan)
                                    <img class="b-r-50" src="{{ url('/storage/' . auth()->user()->foto_karyawan) }}"
                                        alt="" style="width: 50px">
                                @else
                                    <img class="b-r-50" src="{{ url('/html/assets/images/dashboard/profile.jpg') }}"
                                        alt="">
                                @endif
        ...
        <div class="page-body-wrapper">
            <div class="sidebar-wrapper">
                <div>
                    <div class="logo-wrapper"><a href="{{ url('/dashboard') }}"><img
                                class="img-fluid for-light me-2" src="{{ asset('/storage/' . $settings->logo) }}"
                                style="width: 50px" alt=""></a>
                        <div style="font-size: 20px; color:white; display:inline">{{ $settings->name }}</div>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="menu-box">
                                    <ul>
                                        ...
                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                                href="{{ url('/data-center') }}"><i data-feather="server">
                                                </i><span>Data Center</span></a>
                                        </li>

                                        <li class="sidebar-list">
                                            <a class="sidebar-link sidebar-title link-nav"
                                                href="{{ url('/registration') }}"><i data-feather="book">
                                                </i><span>Registration</span></a>
                                        </li>
                                        ...
                                        @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('super_admin'))
                                            <li class="sidebar-list">
                                                <a class="sidebar-link sidebar-title link-nav"
                                                    href="{{ url('/role') }}"><i data-feather="airplay">
                                                    </i><span>Role</span></a>
                                            </li>
                                        @endif
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 p-0 footer-left">
                            <p class="mb-0">Copyright © 2026 CRM R-Tech. All rights reserved.</p>
                        </div>
