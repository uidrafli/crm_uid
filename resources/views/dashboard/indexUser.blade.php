                        ...
                        <li>
                            <a href="{{ url('/pengajuan_ro/create') }}">
                                <img src="{{ asset('assets/icon-image/add-task.png') }}"
                                    style="width: 30px; height: auto; margin-left: 13px;" alt="Face Detection">
                                <p>Tambah RO</p>
                            </a>
                        </li>
        ...
        <div class="tf-container">
            ...
            <div class="mt-5">
                <div class="d-flex justify-content-between">
                    <h3>Informasi</h3>
                    {{-- <a href="{{ url('/informasi-user') }}" class="primary_color fw_6">View
                        All</a> --}}
                </div>
            ...
            <div class="">
                {{-- <div class="d-flex justify-content-between">
                    <h3>Berita</h3>
                    <a href="{{ url('/berita-user') }}" class="primary_color fw_6">View All</a>
                </div> --}}
                <div class="swiper-container banner-tes">
                    <div class="swiper-wrapper">
