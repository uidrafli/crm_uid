            ...
            <div class="tf-balance-box">
                <form method="post" class="tf-form" action="{{ url('/request-location/update/'.$lokasi->id) }}">
                    ...
                    @csrf
                        ...
                        <div class="group-input">
                            <label style="z-index: 10" for="keterangan">Keterangan</label>
                            <select name="keterangan" id="keterangan" class="@error('keterangan') is-invalid @enderror select2" data-live-search="true">
