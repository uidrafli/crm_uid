            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-md-6 p-0">
                        ...
                        <a href="{{ url('/lokasi-kantor/pending-location') }}" class="btn btn-warning float-right btn-sm"><i class="fa fa-hourglass-start me-2"></i> Pending Location</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="mytable" class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($data_lokasi as $key => $dl)
                                    <tr>
                                        <td>{{ ($data_lokasi->currentpage() - 1) * $data_lokasi->perpage() + $key + 1 }}.</td>
                                        ...
                                        <td class="text-center">
                                            @if ($dl->keterangan == 'Patroli')
                                                <a href="{{ url('/lokasi-kantor/qrcode/'.$dl->id) }}" class="btn" style="width: 150px; background-color:rgb(196, 196, 196)"><i class="fas fa-qrcode"></i> Qrcode</a>
                                            @else
                                                -
                                            @endif
                                        </td>
