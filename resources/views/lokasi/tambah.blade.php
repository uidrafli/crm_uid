...
@section('isi')
    <div class="row">
                    ...
                    <form method="post" action="{{ url('/lokasi-kantor/tambah-proses') }}">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror selectpicker" data-live-search="true">
        ...
        <div class="col-md-2">
            <center>
                <h1 style="color: rgb(124, 114, 114)">OR</h1>
            </center>
        </div>
        <div class="col-lg-5">
            <div class="card">
