  ...
  <div class="container">
    ...
    <table style="font-size: 13px">
      <tbody>
        ...
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Tunjangan Makan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px">{{ $data->jumlah_tunjangan_makan }}</td>
          <td style="padding-left: 10px; padding-right: 10px">Hari</td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_tunjangan_makan) }}</td>
        </tr>

        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Tunjangan Transport</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px">{{ $data->jumlah_tunjangan_transport }}</td>
          <td style="padding-left: 10px; padding-right: 10px">Hari</td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_tunjangan_transport) }}</td>
        </tr>

        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Tunjangan BPJS Kesehatan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_tunjangan_bpjs_kesehatan) }}</td>
        </tr>

        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Tunjangan BPJS Ketenagakerjaan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_tunjangan_bpjs_ketenagakerjaan) }}</td>
        </tr>
        ...
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Bonus Pribadi</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->bonus_pribadi) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Bonus Team</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->bonus_team) }}</td>
        </tr>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Bonus Jackpot</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->bonus_jackpot) }}</td>
        </tr>
        <tr>
    ...
    <table style="font-size: 13px">
      <tbody>
        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Potongan BPJS Kesehatan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_potongan_bpjs_kesehatan) }}</td>
        </tr>

        <tr>
          <td style="padding-left: 10px; padding-right: 10px">Potongan BPJS Ketenagakerjaan</td>
          <td style="padding-left: 10px; padding-right: 10px">:</td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px"></td>
          <td style="padding-left: 10px; padding-right: 10px">Rp {{ number_format($data->total_potongan_bpjs_ketenagakerjaan) }}</td>
        </tr>
