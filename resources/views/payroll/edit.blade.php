                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('gaji_pokok') is-invalid @enderror" name="gaji_pokok" value="{{ old('gaji_pokok', $data->gaji_pokok) }}" id="gaji_pokok" style="background-color: orange">
                    ...
                    <div class="row">
                         <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control @error('jumlah_tunjangan_makan') is-invalid @enderror" name="jumlah_tunjangan_makan" value="{{ old('jumlah_tunjangan_makan', $data->jumlah_tunjangan_makan) }}" id="jumlah_tunjangan_makan" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Kali</span>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('uang_tunjangan_makan') is-invalid @enderror" id="uang_tunjangan_makan" name="uang_tunjangan_makan" value="{{ old('uang_tunjangan_makan', $data->uang_tunjangan_makan) }}">
                                    <div class="input-group-text">
                    ...
                    <div class="row">
                         <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control @error('jumlah_tunjangan_transport') is-invalid @enderror" name="jumlah_tunjangan_transport" value="{{ old('jumlah_tunjangan_transport', $data->jumlah_tunjangan_transport) }}" id="jumlah_tunjangan_transport" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Kali</span>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('uang_tunjangan_transport') is-invalid @enderror" id="uang_tunjangan_transport" name="uang_tunjangan_transport" value="{{ old('uang_tunjangan_transport', $data->uang_tunjangan_transport) }}">
                                    <div class="input-group-text">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('total_tunjangan_bpjs_kesehatan') is-invalid @enderror" name="total_tunjangan_bpjs_kesehatan" value="{{ old('total_tunjangan_bpjs_kesehatan', $data->total_tunjangan_bpjs_kesehatan) }}" id="total_tunjangan_bpjs_kesehatan" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Bulan</span>
                                    </div>
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('total_potongan_bpjs_kesehatan') is-invalid @enderror" name="total_potongan_bpjs_kesehatan" value="{{ old('total_potongan_bpjs_kesehatan', $data->total_potongan_bpjs_kesehatan) }}" id="total_potongan_bpjs_kesehatan" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Bulan</span>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('total_tunjangan_bpjs_ketenagakerjaan') is-invalid @enderror" name="total_tunjangan_bpjs_ketenagakerjaan" value="{{ old('total_tunjangan_bpjs_ketenagakerjaan', $data->total_tunjangan_bpjs_ketenagakerjaan) }}" id="total_tunjangan_bpjs_ketenagakerjaan" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Bulan</span>
                                    </div>
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('total_potongan_bpjs_ketenagakerjaan') is-invalid @enderror" name="total_potongan_bpjs_ketenagakerjaan" value="{{ old('total_potongan_bpjs_ketenagakerjaan', $data->total_potongan_bpjs_ketenagakerjaan) }}" id="total_potongan_bpjs_ketenagakerjaan" style="background-color: orange">
                                    <div class="input-group-text">
                                        <span>/ Bulan</span>
                                    </div>
                    ...
                    <div class="row">
                         <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('bonus_pribadi') is-invalid @enderror" id="bonus_pribadi" style="background-color: orange" name="bonus_pribadi" value="{{ old('bonus_pribadi', $data->bonus_pribadi) }}">
                                    <div class="input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('bonus_team') is-invalid @enderror" id="bonus_team" name="bonus_team" style="background-color: orange" value="{{ old('bonus_team', $data->bonus_team) }}">
                                    <div class="input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control money @error('bonus_jackpot') is-invalid @enderror" id="bonus_jackpot" style="background-color: orange" name="bonus_jackpot" value="{{ old('bonus_jackpot', $data->bonus_jackpot) }}">
                                    <div class="input-group-text">
