...
class LemburController extends Controller
{
    ...
    public function masuk(Request $request)
    {
        ...
        // } else {
            ...
            $validatedData['notes'] = 'Yes';
            $validatedData['approved_by'] = 1;

            Lembur::create($validatedData);

            $request->session()->flash('success', 'Berhasil Masuk Overtime');
    ...
    public function pulang(Request $request, $id)
    {
        ...
        // } else {
            ...
            return redirect('/lembur')->with('success', 'Berhasil Pulang Overtime');
        // }
